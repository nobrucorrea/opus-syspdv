...
public class RetaguardaSysPDVFirebird extends Retaguarda {
    ...
    String codPisSuspensao;
    String codCofinsSuspensao;
    String codPisOutros;
    ...
    public void preProcessamento(Produto produto) throws Exception {
        ...
        codPisSuspensao = ConfiguracaoContexto.getInstance().getConfiguracao().getProperty("pis.suspensao");
        codCofinsSuspensao = ConfiguracaoContexto.getInstance().getConfiguracao().getProperty("cofins.suspensao");
    ...
    public boolean atualizarPISCOFINS(Produto produto) throws Exception {
        ...
        if(cstSaida == 9){
            ...
            idPis = codPisSuspensao;
            idCofins = codCofinsSuspensao;
        }
        if(cstSaida == 49){
            idPis = codPisOutros;
        ...
        logger.info("%s %s %d",idPis, idCofins, cstSaida );
    ...
    public boolean atualizarICMS(Produto produto) throws Exception {
        ...
        if (modalidade.equals("lucro_real") || modalidade.equals("lucro_presumido") ) {                                                                  
            ...
            if (icmsCstSadiaConsumidorFinal.equals("000") && icmsSaidaConsumidorFinalDouble.intValue() == 18) {//0 ou 00               
                builder.append("UPDATE produto SET trbid = '");
                builder.append(T18);
                builder.append("' WHERE procod = '");
                builder.append(codigoInterno);
        ...
        if (modalidade.equals("simples")) {
            ...
            if (codigoCsosn.equals("102") && icmsSaidaConsumidorFinalDouble.intValue() == 18) {
                builder.append("UPDATE produto SET trbid = '");
                builder.append(T18);
                builder.append("' WHERE procod = '");
                builder.append(codigoInterno);
